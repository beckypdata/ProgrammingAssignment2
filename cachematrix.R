...
## cacheSolve will calculate the inverse for matrix contained within list structure
...
##    and associated functions/method
w <- makeCacheMatrix(z)
...
## Now calculate the inverse and store in list
...
epsilon <- 1e-16
print(matrix(as.numeric(sprintf("%.14f", abs(abs(z%*%zinv)-epsilon))),4,4))
